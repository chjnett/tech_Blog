...
COLORS = {
    'MHA': '#D946EF',     # Fuchsia
    'GQA-4': '#0EA5E9',   # Sky Blue
    'GQA-2': '#10B981',   # Emerald
    'MQA': '#F59E0B',     # Amber
    'MLA': '#8B5CF6',     # Violet (MLA)
}
...
kv_data = {
    'MHA':   [6.00, 48.00, 384.00, 1536.00],
    'GQA-4': [3.00, 24.00, 192.00,  768.00],
    'GQA-2': [1.50, 12.00,  96.00,  384.00],
    'MQA':   [0.75,  6.00,  48.00,  192.00],
    'MLA':   [0.38,  3.00,  24.00,   96.00],
}
...
speed_data = {
    'MHA':   [1394.8, 1028.4,  664.8],
    'GQA-4': [1433.6,  909.8,  608.5],
    'GQA-2': [1528.6, 1074.4,  663.2],
    'MQA':   [1579.9, 1384.1,  825.8],
    'MLA':   [1597.4, 1324.1,  740.0],
}
